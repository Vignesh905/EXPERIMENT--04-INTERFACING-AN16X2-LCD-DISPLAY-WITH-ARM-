...
{
  Lcd_cursor(&lcd, 0, 1);
  Lcd_string(&lcd, "Pv.vignesh");

  Lcd_cursor(&lcd, 1, 1);
  Lcd_string(&lcd, "212224040229");
}
/* USER CODE END 4 */
...
## Output screen shots of proteus  :
 <img width="961" height="846" alt="Screenshot 2025-09-17 093502" src="https://github.com/user-attachments/assets/85584a0c-ef2b-4739-9235-0f972400be0e" />

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![WhatsApp Image 2025-09-17 at 09 37 37_95205755](https://github.com/user-attachments/assets/ed965b26-c0b9-409a-98b8-3e872683dfc7)
